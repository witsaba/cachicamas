...
>
> **Amended 2026-08-20 (AG-21 archive)**: Promoted verbatim as a new capability at archive; 8 requirements (`R-CNH-001`…`R-CNH-008`), 17 scenarios (`S-CNH-001`…`S-CNH-017`) and 5 non-functional requirements (`NFR-CNH-001`…`NFR-CNH-005`) carried unchanged from the change's own spec. See the archive report for full traceability.
