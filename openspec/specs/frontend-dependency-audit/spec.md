...
> **Capability**: opt-in SCA commands for `frontend/`, severity/scope gate semantics, exit-code contract, and documented baseline obligation
> **Source change**: `frontend-vuln-check` (2026-08-01, merged PR #103)
