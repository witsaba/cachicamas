...
>
> **Amended 2026-08-21 (AG-22 archive)**: Promoted verbatim as a new capability at archive; 10 requirements (`R-AGO-001`…`R-AGO-010`), 55 scenarios (`S-AGO-001`…`S-AGO-094`) and 4 non-functional requirements (`NFR-AGO-001`…`NFR-AGO-004`) carried unchanged from the change's own spec. See the archive report for full traceability.
