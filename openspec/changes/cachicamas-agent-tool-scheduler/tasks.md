...
- [x] 1.1 Commit `openspec/changes/cachicamas-agent-tool-scheduler/{proposal.md, exploration.md, specs/, design.md, tasks.md}` + `openspec/specs/agent-tool-scheduler/spec.md`. No code. `make test` green.
