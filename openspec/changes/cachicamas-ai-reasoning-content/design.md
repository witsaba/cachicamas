...
> **Inherited whole**: [AI-06's `decision.md`](../cachicamas-ai-content-parts/decision.md) — especially § 6 (accessor shape), § 7 (validation), § 8 (the five steps) and **§ 9 (the inheritance table)**
