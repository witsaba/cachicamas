...
> **Binding sibling**: [AI-16 text events](../../../cachicamas-ai-text-events/specs/ai-text-events/spec.md) — `R-ATE-003`/`R-ATE-004` fix the shared block-index space as **1-based with 0 as a rejected sentinel**. This spec adopts that convention verbatim; it does not restate a competing base.
