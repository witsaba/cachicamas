...
> **Sources**: [doc 0002 — Layer 1 task graph](../../../docs/architecture/milestones/0002-cachicamas-ai-layer-1-task-graph.md) · [doc 0001 — agent stack v2](../../../docs/architecture/0001-cachicamas-agent-stack-v2.md) § 3.1 · [the register](../../specs/ai-contract-vocabulary/spec.md) · [AI-04's decision](../cachicamas-ai-validation-errors/decision.md) · [AI-05's design](../cachicamas-ai-message-roles/design.md) § 4
