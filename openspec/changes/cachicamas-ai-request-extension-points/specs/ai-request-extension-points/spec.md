...
> **Binding input**: [the register](../../../../specs/ai-contract-vocabulary/spec.md) — `V-REQ-19` … `V-REQ-29`, `V-FAIL-01` … `V-FAIL-04`, `V-FAIL-13` · [AI-10's spec](../../../cachicamas-ai-model-request/specs/ai-model-request/spec.md) `R-AMR-001` … `R-AMR-017` and its [`design.md`](../../../cachicamas-ai-model-request/design.md) §§ 8, 11, 12 · [`explore.md`](../../explore.md) · [`proposal.md`](../../proposal.md)
