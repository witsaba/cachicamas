...
All **(AI-14)** name pins below are now FINAL. `sdd-apply` remains gated behind AI-14's merge, which is satisfied (AI-14 archived, `openspec/specs/ai-event-envelope/` promoted per doc 0002 milestone tracking).
