...
> **Binding input**: [the register](../../../../specs/ai-contract-vocabulary/spec.md) — `V-REQ-14`, `V-REQ-19`, `V-REQ-20`, `V-REQ-22`, `V-REQ-23`, `V-REQ-24`, `V-REQ-25`, `V-MET-09`, `V-FAIL-01` … `V-FAIL-04`, `V-FAIL-13`, `V-FAIL-17` · [AI-10's spec](../../../cachicamas-ai-model-request/specs/ai-model-request/spec.md) and its [`design.md`](../../../cachicamas-ai-model-request/design.md) §§ 4, 11, 12 · [`explore.md`](../../explore.md) · [`proposal.md`](../../proposal.md)
