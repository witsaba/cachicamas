# Spec delta — Agent package scaffold and boundary guards (`agent-package-scaffold`)
...
> **New capability** — no prior `openspec/specs/agent-package-scaffold/spec.md`, so this is a full spec, promoted verbatim at archive.
