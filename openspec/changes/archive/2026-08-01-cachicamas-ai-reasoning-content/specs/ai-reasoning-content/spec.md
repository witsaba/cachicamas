...
> **Phase**: spec (delta)
> **Canonical spec**: `openspec/specs/ai-reasoning-content/spec.md` — created by `sdd-archive` from this delta
> **Format**: RFC 2119 keywords + Given/When/Then, per `openspec/config.yaml`
> **Date**: 2026-07-31
> **Requirement IDs**: `R-ARC-0NN` · **Scenario IDs**: `S-ARC-0NN`
> **Binding input**: [the register](../../../../../specs/ai-contract-vocabulary/spec.md) — `V-REQ-09`, `V-REQ-10`, `V-REQ-11`, and `V-REQ-04` … `V-REQ-07` inherited · [AI-06's spec](../../../2026-08-01-cachicamas-ai-content-parts/specs/ai-content-parts/spec.md) and [`decision.md`](../../../2026-08-01-cachicamas-ai-content-parts/decision.md) · [AI-04's spec](../../../2026-08-01-cachicamas-ai-validation-errors/specs/ai-validation-errors/spec.md)
