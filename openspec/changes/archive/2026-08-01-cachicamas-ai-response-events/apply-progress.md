...
> **Archive-time note, 2026-08-01 — deviation 2 is discharged.** The Wave 2 archive pass promoted AI-14 for real: `openspec/specs/ai-event-envelope/spec.md` now exists, and AI-14's change folder moved to `openspec/changes/archive/2026-08-01-cachicamas-ai-event-envelope/`. This apply record was **correct** about the gap when it was written — the Wave 2 verify report cross-checked it and found that AI-15's own `design.md` contradicted it with a false "AI-14 archived" claim (**W6**/**D8**); the design.md text was the wrong one, and it was corrected in the same archive pass. Nothing above is changed; this note only records that the flagged follow-up landed.
