...
> **ARCHIVED DELTA — historical record.** The live contract is [`openspec/specs/ai-response-events/spec.md`](../../../../../specs/ai-response-events/spec.md), promoted from this file on 2026-08-01. This copy is preserved as the artifact AI-15 was verified against. Relative links below were re-resolved for the archive path; nothing else was changed.
