...
func TestUsage_OnlyPromptAndCompletionTokens_UnmappedFieldsReadAbsent(t *testing.T) {
	...
	transcript := usageTranscript("data: {\"id\":\"chatcmpl-u\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[],\"usage\":{\"prompt_tokens\":11,\"completion_tokens\":22,\"total_tokens\":33}}\n\n")
...
func TestUsage_ExplicitZero_ReportsReportedZeroNotAbsent(t *testing.T) {
	...
	transcript := usageTranscript("data: {\"id\":\"chatcmpl-u\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[],\"usage\":{\"prompt_tokens\":0,\"completion_tokens\":5,\"total_tokens\":5}}\n\n")
	server := sseServer(t, transcript)
	defer server.Close()
	c := mustClient(t, server.URL)
	ch, err := c.Stream(context.Background(), validRequest(t))
...
func TestUsage_OmittedVsExplicitZero_UsageRecordsNotEqual(t *testing.T) {
	...
	omitted := usageTranscript("data: {\"id\":\"chatcmpl-u\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[],\"usage\":{\"completion_tokens\":5,\"total_tokens\":5}}\n\n")
	explicitZero := usageTranscript("data: {\"id\":\"chatcmpl-u\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[],\"usage\":{\"prompt_tokens\":0,\"completion_tokens\":5,\"total_tokens\":5}}\n\n")
...
func TestUsage_NullOnNonFinalChunks_DoesNotOverwritePopulatedUsage(t *testing.T) {
	...
	transcript := "" +
		...
		"data: {\"id\":\"chatcmpl-u\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[],\"usage\":{\"prompt_tokens\":7,\"completion_tokens\":9,\"total_tokens\":16}}\n\n" +
		"data: [DONE]\n\n"
	server := sseServer(t, transcript)
	defer server.Close()
	c := mustClient(t, server.URL)
...
func TestUsage_PresenceAssertedPositively_AndNegativeControlFails(t *testing.T) {
	...
	withUsage := usageTranscript("data: {\"id\":\"chatcmpl-u\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[],\"usage\":{\"prompt_tokens\":4,\"completion_tokens\":6,\"total_tokens\":10}}\n\n")
...
func TestUsage_EmptyChoicesArray_NoTextEventNoProtocolViolation(t *testing.T) {
	...
	transcript := usageTranscript("data: {\"id\":\"chatcmpl-u\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[],\"usage\":{\"prompt_tokens\":1,\"completion_tokens\":2,\"total_tokens\":3}}\n\n")
	server := sseServer(t, transcript)
	defer server.Close()
	c := mustClient(t, server.URL)
	ch, err := c.Stream(context.Background(), validRequest(t))
