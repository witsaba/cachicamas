...
func TestTerminal_TerminalChunkThenDone_EndsCleanlyWithCompletion(t *testing.T) {
	...
	transcript := "" +
		"data: {\"id\":\"chatcmpl-term\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[{\"index\":0,\"delta\":{},\"finish_reason\":\"stop\"}]}\n\n" +
		"data: [DONE]\n\n"
...
func TestTerminal_DoneWithNoPaddingBeyondMandatoryBlankLine_SameOutcome(t *testing.T) {
	...
	transcript := "" +
		"data: {\"id\":\"chatcmpl-pad\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[{\"index\":0,\"delta\":{},\"finish_reason\":\"stop\"}]}\n\n" +
		"data: [DONE]\n\n"
	server := sseServer(t, transcript)
	defer server.Close()
...
func TestTerminal_WellFormedChunkAfterSentinel_Ignored(t *testing.T) {
	...
	transcript := "" +
		"data: {\"id\":\"chatcmpl-post\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[{\"index\":0,\"delta\":{},\"finish_reason\":\"stop\"}]}\n\n" +
		"data: [DONE]\n\n" +
		"data: {\"id\":\"chatcmpl-post\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[{\"index\":0,\"delta\":{\"content\":\"ghost\"},\"finish_reason\":null}]}\n\n"
	server := sseServer(t, transcript)
	defer server.Close()
...
func TestTerminal_MalformedFrameAfterSentinel_StillEndsCleanly(t *testing.T) {
	...
	transcript := "" +
		"data: {\"id\":\"chatcmpl-mal\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[{\"index\":0,\"delta\":{},\"finish_reason\":\"stop\"}]}\n\n" +
		"data: [DONE]\n\n" +
...
func TestTerminal_DuplicateSentinel_ExactlyOneTerminalEvent(t *testing.T) {
	...
	transcript := "" +
		"data: {\"id\":\"chatcmpl-dup\",\"model\":\"m\",\"object\":\"chat.completion.chunk\",\"created\":1700000000,\"choices\":[{\"index\":0,\"delta\":{},\"finish_reason\":\"stop\"}]}\n\n" +
		"data: [DONE]\n\n" +
		"data: [DONE]\n\n"
	server := sseServer(t, transcript)
	defer server.Close()
