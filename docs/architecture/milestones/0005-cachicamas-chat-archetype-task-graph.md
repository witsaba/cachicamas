...
> **Status:** Not started — **0 of 12** milestones shipped. **CH-00 is the first milestone.** No Layer 3 archetype exists yet on disk; this is the first one scheduled to ship.
...
- [ ] Vocabulary, every seam's v1 answer and its injection point, and v1 scope are recorded — closed by CH-00.1
...
| Register 4 — the mandated offline literal | CH-05.2 |
